...
def plot_functions(target_x, target_y, context_x, context_y, pred_y, std, plot_batch=0):
...
def plot_functions_multidim(
    ...
    Args:
      ...
      epoch_title: Title for the plot indicating the epoch.
